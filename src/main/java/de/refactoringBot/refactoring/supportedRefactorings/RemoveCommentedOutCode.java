...
public class RemoveCommentedOutCode extends VoidVisitorAdapter<Object> {
     ...
     * @throws IOException
     */
    private void removeLinesFromFile(int start, int end, String path, boolean isLineComments) throws FileNotFoundException, IOException {
        ...
        while ((currentLine = reader.readLine()) != null) {
            ...
            if ((lineNumber >= start) && (lineNumber <= end)) {
                ...
                if ((!currentLine.trim().startsWith("//")) && isLineComments) {
                    sb.append(currentLine.substring(0, currentLine.indexOf("//"))).append(System.getProperty("line.separator"));
