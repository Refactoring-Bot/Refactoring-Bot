...
public class BotOperationsLexer extends Lexer {
	...
	public static final String[] ruleNames = { "T__0", "REFACTORING", "ADD", "RENAME", "REORDER", "REMOVE", "ADDKIND",
			"REORDERKIND", "REMOVEKIND", "RENAMEKIND", "METHOD", "CLASS", "VARIABLE", "ANNOTATION", "MODIFIER",
			"PARAMETER", "LINE", "WORD", "UPPERCASE", "LOWERCASE", "DIGIT", "WHITESPACE" };
	...
	public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\2\26\u00d8\b\1\4\2"
